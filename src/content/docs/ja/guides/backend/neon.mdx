...
description: Neon を使用して Astro プロジェクトにサーバーレス Postgres データベースを追加する
sidebar:
  label: Neon
type: backend
service: Neon
...
- [Neon サーバーレスドライバー GitHub](https://github.com/neondatabase/serverless)
- [Astro サイトまたはアプリケーションを Neon Postgres に接続する](https://neon.tech/docs/guides/astro)